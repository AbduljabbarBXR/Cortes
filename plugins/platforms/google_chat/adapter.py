...
#     fresh "Cortes is thinking…" card during the small window between
...
class GoogleChatAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # they don't sit in the chat forever as "Cortes is thinking…".
    ...
    async def send_typing(self, chat_id: str, metadata: Any = None) -> None:
        """Post a visible 'Cortes is thinking…' marker message.
        ...
        "Cortes is thinking…" stuck in chat forever, plus one card that
    ...
    async def stop_typing(self, chat_id: str) -> None:
        ...
        Google Chat has no separate typing API: the "Cortes is thinking…"
    ...
    async def on_processing_complete(
        ...
        see "Cortes is thinking…" stuck forever.
        """
    ...
    async def _consume_typing_card_with_text(
        ...
        creating a fresh "Cortes is thinking…" card during any subsequent
...
def register(ctx) -> None:
    """Plugin entry point — called by the Cortes plugin system at startup.
    ...
    ctx.register_platform(
        ...
        # the "Cortes is thinking..." marker patches and edit overhead.
        ...
        platform_hint=(
            ...
            "are generating a response, a 'Cortes is thinking…' marker message "
