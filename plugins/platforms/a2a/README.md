# A2A — Agent-to-Agent protocol for Cortes
...
peer (another Cortes, LangChain, CrewAI, Google ADK, OpenClaw, …). Stdlib only —
...
When the `a2a` platform is enabled, Cortes serves a v1.0 Agent Card at
