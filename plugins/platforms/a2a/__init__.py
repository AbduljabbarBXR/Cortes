"""
A2A (Agent-to-Agent) plugin for Cortes Agent.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes Cortes as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    ...
    print_info("Expose Cortes as an A2A-discoverable agent and call other A2A agents.")
