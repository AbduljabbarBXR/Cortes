...
Credential storage mirrors every other Cortes channel:
...
# registers Cortes as its own client_id.
...
# Default name of the project Cortes provisions for the operator.
DEFAULT_PROJECT_NAME = "Cortes Agent"
...
def _auth_json_path() -> Path:
    """Resolve ``~/.hermes/auth.json`` honouring the active Cortes profile."""
    try:
