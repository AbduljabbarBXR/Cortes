"""SimpleX Chat platform adapter (Cortes plugin).
...
This adapter ships as a Cortes platform plugin under
``plugins/platforms/simplex/``. The Cortes plugin loader scans the
...
# Imported at module top because they're stdlib-only inside Cortes — no
