"""
Email platform adapter for the Cortes gateway.

Allows users to interact with Cortes by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Cortes Agent")
