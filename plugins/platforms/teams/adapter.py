"""
Microsoft Teams platform adapter for Cortes Agent.
...
def _suppress_third_party_dotenv() -> Iterator[None]:
    ...
    Cortes owns dotenv loading; third-party import side effects must not.
    """
    try:
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            self._app = App(
                ...
                client=ClientOptions(headers={"User-Agent": "Cortes"}),
            )
...
def interactive_setup() -> None:
    ...
    print_info("  teams app create --name \"Cortes\" --endpoint \"https://<tunnel>/api/messages\"")
    print()
...
def _install_hint() -> str:
    ...
    ``feature_install_command(venv_pip=True)`` targets the actual Cortes
