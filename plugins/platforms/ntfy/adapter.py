"""ntfy platform adapter (Cortes plugin).
...
``plugins/platforms/ntfy/``. The Cortes plugin loader scans the
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Cortes dependency",
