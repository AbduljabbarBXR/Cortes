...
# When the user hasn't picked a reasoning effort, Cortes passes
...
# ON at this effort — matching the "medium (default)" that Cortes' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Cortes' effort vocabulary onto Solar's accepted set. xhigh/max/
