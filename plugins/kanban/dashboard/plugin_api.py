...
def _active_profile_name() -> str:
    """Return the current Cortes profile name for notify-sub ownership."""
    try:
...
def model_options():
    ...
    dropdown can never offer a model/provider pair the rest of Cortes
...
def list_kanban_projects():
    """List first-class Cortes projects for board scoping.
