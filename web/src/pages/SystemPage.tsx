...
export default function SystemPage() {
  ...
  const applyUpdate = async () => {
    ...
    if (status?.can_update_hermes === false) {
      showToast(
        "Cortes updates are managed outside this dashboard.",
        "success",
      );
      return;
    }
        ...
        <Card>
          <CardContent className="flex flex-col gap-4 py-4">
            ...
            <ConfirmDialog
              ...
              title="Restore full Cortes backup?"
              description={`This will overwrite your current Cortes configuration, skills, sessions, and data with the contents of ${backupImportLabel(importConfirmTarget)}. This cannot be undone.`}
              destructive
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-muted-foreground max-w-prose">
                    ...
                    returns links to send the Cortes team. Pastes auto-delete
                    after 6 hours.
                  </span>
                </div>
              </div>
