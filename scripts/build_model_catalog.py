#!/usr/bin/env python3
"""Build the Cortes Model Catalog — a centralized JSON manifest of curated models.
...
Cortes CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Cortes release.
            ...
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Cortes '
