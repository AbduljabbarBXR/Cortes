...
This is an additive Cortes extension surfaced under ACP ``_meta.hermes`` so
...
compression rotates the internal Cortes head, ``build_session_provenance`` lets
...
def build_session_provenance(
    ...
    *,
    ...
    Args:
        ...
        current_hermes_session_id: The live internal Cortes DB session id
