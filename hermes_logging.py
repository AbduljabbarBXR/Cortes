"""Centralized logging setup for Cortes Agent.
...
# essentially always in Cortes (TUI, gateway, ``hy_memory`` server, MCP
...
def setup_logging(
    *,
    ...
    """Configure the Cortes logging subsystem.
    ...
    *force* is ``True``.
    ...
    ----------
    hermes_home
        Override for the Cortes home directory.  Falls back to
...
# the module header): when several Cortes processes log to the same file, an
