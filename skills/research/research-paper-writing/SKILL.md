...
## Cortes Agent Integration

This skill is designed for the Cortes agent. It uses Cortes tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Cortes skills for specific phases:
