...
the Cortes CLI, TUI, and desktop app. This skill drives the `hermes pets` CLI
...
- Pillow (a core Cortes dependency) for sprite decoding — already installed.
...
- The petdex npm CLI installs to `~/.codex/pets`; Cortes uses its own
