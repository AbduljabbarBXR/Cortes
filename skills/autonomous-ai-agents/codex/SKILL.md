...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Cortes terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Cortes itself, `model.provider: openai-codex` uses Cortes-managed Codex
...
## Cortes Gateway Caveat

When invoking the Codex CLI from a Cortes gateway/service context (for example,
