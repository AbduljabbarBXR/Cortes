"""
Timezone-aware clock for Cortes.
...
Invalid timezone values log a warning and fall back safely — Cortes never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — Cortes requires 3.9+)
