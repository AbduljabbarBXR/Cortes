...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Cortes session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Cortes session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Cortes agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Cortes Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Cortes gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Cortes session in it",
