...
There are two ways to add a platform to the Cortes gateway:
...
**zero changes to core Cortes code**.
...
Checklist for integrating a platform directly into the Cortes core.
