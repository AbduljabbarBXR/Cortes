...
Connects Cortes Agent to WeChat personal accounts via Tencent's iLink Bot API.
...
class WeixinAdapter(BasePlatformAdapter):
    """Native Cortes adapter for Weixin personal accounts."""
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        if self._group_policy != "disabled":
            logger.warning(
                ...
                "these accounts, so group messages may never reach Cortes regardless of this "
