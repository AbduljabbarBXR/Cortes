...
Cortes Agent (see website/docs/getting-started/platform-support.md). The
...
Cortes package derivation, so only that build may create an artifact.
...
_BLOCK_MESSAGE = (
    ...
    "Cortes is distributed via the shell installer, Docker image, or Nix.\n"
    ...
    "the Cortes Nix derivation sets HERMES_NIX_BUILD=1. If it does, file a bug."
)
