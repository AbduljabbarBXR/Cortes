"""Coding-context awareness — base Cortes, every interactive surface.

When the user runs Cortes inside a code workspace (CLI, TUI, desktop app, or an
editor over ACP), Cortes shifts into a **coding posture**. This module is the
...
def is_coding_context(
    *,
    ...
    """Whether Cortes should operate in its coding posture right now."""
