...
def _detect_environment(env: str) -> bool:
    ...
    if env == "kanban":
        ...
        # The Cortes Docker image runs s6-overlay as PID 1 (/init). s6 plants
...
def is_external_skill_path(path) -> bool:
    ...
    ``skills.external_dirs`` are externally owned: Cortes can discover and view
...
def iter_skill_index_files(skills_dir: Path, filename: str):
    ...
    Excludes Cortes metadata, VCS, virtualenv/dependency, cache, and skill
