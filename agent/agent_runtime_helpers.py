...
def dump_api_request_debug(
    ...
    *,
    ...
    try:
        ...
        # originate from untrusted input (X-Cortes-Session-Id header), and an
...
def anthropic_prompt_cache_policy(
    ...
    *,
    ...
    # canonicalized only after Cortes sends the request. In that case model
...
def _iter_httpx_pool_objects(http_client: Any):
    ...
    Cortes' keepalive client (#10324 / ``_build_keepalive_http_client``) and
