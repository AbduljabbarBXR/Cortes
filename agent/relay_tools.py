"""Core NeMo Relay adapter for Cortes tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Cortes tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Cortes Relay tool execution cannot run on an active event-loop thread"
    )
