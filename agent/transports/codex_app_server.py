...
projection into Cortes' display, approval bridging, transcript projection into
...
"codex_app_server"`. Cortes' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        # `os.environ.copy()` also handed it every Tier-1 Cortes secret — gateway
