...
def build_turn_context(
    ...
    *,
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Cortes only initiates compaction in "hermes" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Cortes preflight compression for codex app-server "
                "(mode=%s); Cortes will not start thread compaction here.",
    ...
    if agent._memory_manager:
        ...
        # to surface it. Rendered by Cortes (via _emit_status), so it always
