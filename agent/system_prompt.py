...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Cortes never re-renders parts of this string mid-
    ...
    # Pointer to the hermes-agent skill + docs for user questions about Cortes itself.
    ...
    # Coding posture (base Cortes, any interactive coding surface in a code
    ...
    # Active-profile hint — names the Cortes profile the agent is running
    ...
    if active_profile == "default":
        post_workspace_parts.append(
            "Active Cortes profile: default. Other profiles (if any) live "
        ...
        post_workspace_parts.append(
            f"Active Cortes profile: {active_profile}. This session reads "
    ...
    if not agent.skip_context_files:
        ...
        # (developing Cortes). Every other surface (desktop chat panel,
