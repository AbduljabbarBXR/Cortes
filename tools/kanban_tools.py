...
def _connect(board: Optional[str] = None):
    ...
    the env-pinned active board without restarting Cortes.
    """
...
def _handle_attach_url(args: dict, **kw) -> str:
    ...
    The agent passes a URL; Cortes downloads it (with the shared size cap)
...
KANBAN_ATTACH_URL_SCHEMA = {
    ...
    "description": (
        "Attach a file to a task by URL — Cortes downloads it server-side "
