...
Trust levels:
  - builtin:   Ships with Cortes. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.hermes/\.env|\~/\.hermes/\.env',
     ...
     "directly references Cortes secrets file"),
    ...
    (r'\.hermes/config\.yaml|\.hermes/SOUL\.md',
     ...
     "references Cortes configuration files directly"),
...
# scan. `.skillignore` is the Cortes-native name; `.clawhubignore` is honored
