...
def _get_hermes_home() -> Path:
    """Resolve Cortes home dynamically while preserving test monkeypatch hooks.
...
def _open_continuable_cron_thread(
    ...
    thread_name = f"Cortes — {task_name}"
    try:
...
def _run_job_script(
    ...
    * anything else — run with the current Python interpreter
    ...
    provider credentials and other Cortes-managed secrets are not inherited
