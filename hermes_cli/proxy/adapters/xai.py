...
# xAI's public API is OpenAI-compatible for the endpoints Cortes commonly
# uses. The Responses endpoint is included because Cortes' native xAI runtime
...
class XAIGrokAdapter(UpstreamAdapter):
    """Proxy upstream for xAI Grok via Cortes-managed OAuth credentials."""
