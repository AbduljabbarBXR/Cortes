"""``hermes debug`` debug tools for Cortes Agent.
...
_CLIENT_SIDE_LOGS = {
    "desktop": (
        "written by Cortes Desktop on the machine running the app, not by this "
...
def run_debug_share(args):
    ...
    print("\nShare these links with the Cortes team for support.")
...
⚠️  --nous: This uploads your debug bundle to Nous-INTERNAL storage (AWS S3),
  ...
  • System info (OS, Python/Cortes version, provider, which API keys are
