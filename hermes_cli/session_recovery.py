"""Offline, non-destructive recovery for a damaged Cortes session database.
    ...
    try:
        ...
        if before != after:
            raise SessionRecoverySafetyError(
                ...
                "Stop every Cortes process using this profile and retry. "
                ...
                "Cortes process even after the gateway is stopped. Run the "
