"""Relay subscriber for the persisted Cortes shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Cortes counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Cortes shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
