...
version: 1.0.0
author: arceus77-7, enhanced by Cortes Agent
license: MIT
...
- `tmux` available for stable authenticated sessions during Cortes terminal calls (desktop app flow only)
...
### Service Account (recommended for Cortes)
...
## Cortes Execution Pattern (desktop app flow)

Cortes terminal commands are non-interactive by default and can lose auth context between calls.
