...
version: 1.0.1
author: Joe Rinaldi Johnson (joerj123), Cortes Agent
license: MIT
...
| Telegram (Cortes Agent + all other agents) | Do **not** send an image. Send separate messages — never one combined message. |
